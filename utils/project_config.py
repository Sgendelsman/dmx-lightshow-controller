...
SONGS = [
    {'song': f'{MUSIC_DIRECTORY}/unbroken.mp3', 'start_early': 0, 'seek': 0.0, 'beat_delay': 0.520},#0.180},
    {'song': f'{MUSIC_DIRECTORY}/kairo.mp3', 'start_early': 6.495, 'seek': 0.0, 'beat_delay': 0.460},#0.120},
    {'song': f'{MUSIC_DIRECTORY}/doruksen_song1.mp3', 'start_early': 0.774, 'seek': 0.0, 'beat_delay': 0.255},#-0.085},
    {'song': f'{MUSIC_DIRECTORY}/doruksen_song2_1.mp3', 'start_early': 0.59, 'seek': 0.0, 'beat_delay': 0.386},#0.046},
    {'song': f'{MUSIC_DIRECTORY}/kissmealready.mp3', 'start_early': 76.00, 'seek': 0.0, 'beat_delay': 0.340},#0},
    {'song': f'{MUSIC_DIRECTORY}/doruksen_song2_2.mp3', 'start_early': 1.736, 'seek': 0.0, 'beat_delay': 0.280}#-0.060}
]
