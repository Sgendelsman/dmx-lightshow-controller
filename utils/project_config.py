...
BEAT_DELAY_ADJUSTMENT = 1.770 # Offset of beats to sync up to audio playback (in seconds)
START_DELAY = 3 # How many seconds to give all of the processes to sync up before starting the music
...
SONGS = [
    # {'song': f'{MUSIC_DIRECTORY}/unbroken.mp3', 'start_early': 0, 'seek': 180.0},
