...
SONGS = [
    # {'song': f'{MUSIC_DIRECTORY}/unbroken.mp3', 'start_early': 0, 'seek': 120.0, 'beat_delay': 0.180},
    {'song': f'{MUSIC_DIRECTORY}/kairo.mp3', 'start_early': 6.495, 'seek': 240.0, 'beat_delay': 0.120},
