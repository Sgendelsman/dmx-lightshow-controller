...
SONGS = [
    ...
    {'song': f'{MUSIC_DIRECTORY}/doruksen_song2_1.mp3', 'start_early': 0.59, 'seek': 94.0, 'beat_delay': 0.046},
    {'song': f'{MUSIC_DIRECTORY}/kissmealready.mp3', 'start_early': 76.00, 'seek': 0.0, 'beat_delay': 0},
